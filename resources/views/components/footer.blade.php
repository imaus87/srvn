<div>
    ...
    {{-- <section class="grid grid-cols-1 space-x-0 space-y-6 sm:grid-cols-5 sm:space-x-6 sm:space-y-0">
    ...
    <section class="mt-9 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <svg class="bi bi-twitter h-6 w-6"
                 xmlns="http://www.w3.org/2000/svg"
                 fill="currentColor"
                 viewBox="0 0 16 16">
                <path
